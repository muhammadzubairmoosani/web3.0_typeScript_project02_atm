...
const questions = [
    ...
    },
    {
        ...
        when: (ans) => ans.account_type,
    },
];
const doTransaction = (balance, amount) => {
    if (balance > amount) {
        console.log("\nPlease wait...\nyour transaction is in process\n");
        setTimeout(() => {
            console.log(`\nTransaction successful!\nYour current balance is: Rs.${balance - amount}\n=> Please take your card\n `);
        }, 3000);
    }
    else {
...
const initialQuestions = await inquirer.prompt(questions);
